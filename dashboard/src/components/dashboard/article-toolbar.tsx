...
import type { ArticleStatusCounts } from "@/types/article";

const TABS: { key: string; label: string; countKey: keyof ArticleStatusCounts }[] =
  [
...
export function ArticleToolbar({ counts, current }: ArticleToolbarProps) {
