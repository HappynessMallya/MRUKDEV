...
const PRODUCTS: Record<string, Product> = {
  ...
  p605tmswd: {
    ...
    isAvailable: true,
    highlightIcons: [
      { id: 'h1', iconName: 'material-symbols:waves-rounded', label: { en: 'Digital Invetor motor' } },
      { id: 'h2', iconName: 'material-symbols:waves-rounded', label: { en: 'Digital Invetor motor' } },
      { id: 'h3', iconName: 'material-symbols:air-rounded', label: { en: 'Digital Invetor motor' } },
      { id: 'h4', iconName: 'material-symbols:mode-fan-rounded', label: { en: 'Digital Invetor motor' } },
    ],
    characteristics: [
      {
        id: 'c1',
